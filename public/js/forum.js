...
function updateMessages(newMessages) {
  var ids = window._messages.map(function (msg) {
    return msg.id;
  });

  var rendMessages = newMessages.filter(function (msg) {
    return !ids.includes(msg.id);
  });
  rendMessages.forEach(function (msg) {
