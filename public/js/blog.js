...
function getDate(datetime) {
  ...
  return "".concat(date.getDate(), " ").concat(months[date.getMonth()], " <small>").concat(date.getFullYear(), "<small> ").concat(withMinutes ? "\xE0 ".concat(twoDigits(date.getHours()), "H").concat(twoDigits(date.getMinutes())) : '');
}
...
function getPost(post) {
  ...
  var places = post.maxplaces - participants;
...
$(function () {
  try {
    ...
    console.warn('Cant\'t load datetime picker: files were not called');
  }
