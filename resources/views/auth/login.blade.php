...
<div class="AuthLayout">
    ...
    <div class="AuthLayout-form col-7">
        <form class="AuthForm col-9" method="POST" action="{{ route('login') }}">
            @csrf
            ...
            <div class="AuthForm-actions">
                <a href="{{ route('register') }}" class="col-6 btn btn-white backlink">Je n'ai pas de compte</a>
                <button class="col-6 btn btn-dark" type="submit">Se connecter</button>
            </div>
        </form>
    </div>
