...
<div class="BlogsLayout container d-flex flex-column justify-content-center align-items-center">
    <div class="BlogsLayout-pageIntro">
        <section class="PageIntro col-12">
            ...
            <p class="PageIntro-paraph">Retrouvez par catégorie toutes les sessions d'escalade.</p>
    ...
    <div class="BlogsLayout-blogs d-flex flex-column flex-md-row">
        <div class="BlogsList regularsBlogs col-md-6">
        ...
        <div class="BlogsList nonRegularsBlogs col-md-6">
